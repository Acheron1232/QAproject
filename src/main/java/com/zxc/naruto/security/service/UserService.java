...
import com.zxc.naruto.security.exception.custom.UserAlreadyExistsException;
...
public class UserService implements UserDetailsService {
    ...
    public ResponseEntity<String> getCurrentUser(Principal principal){
        ...
        if (user != null) {
            return ResponseEntity.ok(userMapper.mapToUserGetDto(user).toString());
        } else {
    ...
    @SneakyThrows
    public ResponseEntity<String> changeUser(Principal principal, UserChangeDto userChangeDto, HttpServletResponse response) {
        User user = findByEmail(principal.getName()).orElse(null);
        if (user != null) {
